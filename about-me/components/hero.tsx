    ...
    <section className="min-h-screen flex flex-col justify-center items-center px-6 pt-20">
      <div className="max-w-2xl text-center">
        ...
        <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-white mb-6">
          Hi there, I&apos;m{" "}
          <span className="text-indigo-400">Fifaliana Randria</span>
        </h1>
...
Je crée des expériences Web accessibles, performantes et belles avec des technologies modernes.
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a
            href="#projects"
            className="px-6 py-3 bg-white text-zinc-900 rounded-full text-sm font-medium hover:bg-zinc-200 transition-all"
          >
            projet réalisé
          </a>
          <a
            href="#contact"
            className="px-6 py-3 border border-zinc-700 text-white rounded-full text-sm font-medium hover:border-zinc-500 transition-all"
          >
            contactez-moi
          </a>
        </div>
